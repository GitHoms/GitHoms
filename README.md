...
*   **Оптимизация процессов:** Предложил и внедрил новый workflow в Jira для багов (статус "Nice to fix"), что помогло не забывать про мелкие правки, не тормозя разработку. Среднее время жизни бага в системе сократилось.
*   **Автоматизация и покрытие:** Актуализировал тестовую документацию, переведя разрозненные чек-листы в структурированные тест-кейсы (TestIT) и добившись покрытия критичных путей. Автоматизировал ручные сценарии (Python, Postman), сократив время на регресс.
